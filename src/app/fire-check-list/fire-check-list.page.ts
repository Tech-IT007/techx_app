...
export class FireCheckListPage implements OnInit {
  ...
  userdetails :any = {
    ...
    "Observation":"",
    "TypeCylinderCheck": "",
    "CylinderCapacityCheck": "",
    "GripCheck": "",
    "SafetyPinPositionCheck": "",
    "SafetySealAvailableCheck": "",
    "RefilledDateCheck": "",
    "DueDateCheck": "",
    "HydrostaticTestingDateCheck": "",
    "AccessClearnaceExtinguisherCheck": "",
    "VisibleInstructionLabelCheck": "",
    "ExtinguisherCleaning": "",
    "CO2WeightCheck":"",
    "PressureCheck":"",
  ...
  submit (){
    ...
    var url = "https://techxpertindia.in/api/generate_fire_extinguisher_service_report_pdf.php"
