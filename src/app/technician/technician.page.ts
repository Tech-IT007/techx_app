...
export class TechnicianPage implements OnInit {
  ...
  Getdata() {
    ...
    return this.http
      ...
      .subscribe((response) => {
        ...
        this.report_category = this.report_category.data.Service

        // alert(this.report_category)
        this.post_img = response
        this.post_img = this.post_img.data.PostImg
         console.log("post_point" , this.post_img)
        if (this.post_img == 0) {
      ...
      console.log("pre_point" , this.pre_img)
        // alert(this.pre_img)
        if (this.pre_img == 0) {
        ...
        this.services_reports = this.services_reports.data.GeneralServiceReport
          console.log("digital_services" , this.services_reports)
        ...
        if (this.pre_img == 0 || this.post_img == 0 || this.services_reports == 0) {
          this.button = false;
        } else {
          this.button = true;
        }
  ...
  report() {
    if (this.report_category == "HVAC") {
      this.router.navigateByUrl("/new-havc")
    }
    else if (this.report_category == "CCTV") {
