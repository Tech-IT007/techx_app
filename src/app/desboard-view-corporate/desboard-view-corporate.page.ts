...
@Component({
  selector: 'app-desboard-view-corporate',
  templateUrl: './desboard-view-corporate.page.html',
  styleUrls: ['./desboard-view-corporate.page.scss'],
})
export class DesboardViewCorporatePage implements OnInit {
  BookingID: any;
  buttonColor: any;
  ...
  dataToSend = {
    ...
    "Status":localStorage.getItem("Corporate_status")
  ...
  runHttp() {
    ...
    var url = "https://techxpertindia.in/api/get_corporate_tickets_status_with_employee.php"
  ...
  route_to_profile_answer_screen(userID) {
    ...
    this.router.navigate(['deshbord-view-details-coporate'], navigationExtras);
  }
